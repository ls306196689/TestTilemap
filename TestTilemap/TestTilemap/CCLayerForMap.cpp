...
CCScene* CCLayerForMap::scene()
{
    ...
    CCLayerForMap *layer = CCLayerForMap::create();
...
void CCLayerForMap::menuCloseCallback(CCObject* pSender)
{
...
void CCLayerForMap::testTMX()
{
    ...
    schedule( schedule_selector(CCLayerForMap::repositionSprite) );
}
void CCLayerForMap::repositionSprite(float dt)
{
...
void CCLayerForMap::updateMap()
{
    //    CCNode *map = getChildByTag(TAG_map);
}
void CCLayerForMap::ccTouchesBegan(cocos2d::CCSet *pTouches, cocos2d::CCEvent *pEvent)
{
    
    //    addCCTouch(pTouches);
}
void CCLayerForMap::ccTouchesMoved(cocos2d::CCSet *pTouches, cocos2d::CCEvent *pEvent)
{
...
void CCLayerForMap::ccTouchesCancelled(cocos2d::CCSet *pTouches, cocos2d::CCEvent *pEvent)
{
    removeCCTouch(pTouches);
    //    m_delta_last = CCPointZero;
}

bool CCLayerForMap::checkShouldScale()
{
...
bool CCLayerForMap::checkShouldMove()
{
...
void CCLayerForMap::updateLayerAnchorPoint()
{
...
void CCLayerForMap::addCCTouch(cocos2d::CCSet *pTouches)
{
...
void CCLayerForMap::removeCCTouch(cocos2d::CCSet *pTouches)
{
    while (pTouches->count() > 0) {
...
cocos2d::CCPoint CCLayerForMap::getMapNewPosition(cocos2d::CCPoint dpos, int edgemode)//0:只能靠边；1：无需靠边，2：无需靠边，但离边越远反应越迟钝
{
    CCNode *map  = getChildByTag(TAG_map);
...
void CCLayerForMap::moveMapByPosition(cocos2d::CCPoint pos, int edgemode, bool withaction)//0:只能靠边；1：无需靠边，2：无需靠边，但离边越远反应越迟钝
{
    CCNode *map  = getChildByTag(TAG_map);
